...
**NOTE**: A more efficient copy protocol is **rsync**. It copies over only what has changed between the tow locations, thus preventing costly copying over of files that have not changed since the previous copying. This saves time and resources. See [](). 
